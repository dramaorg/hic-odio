...
[![NPM Version](https://img.shields.io/npm/v/@dramaorg/hic-odio.svg?style=flat-square)](https://www.npmjs.com/package/@dramaorg/hic-odio)
[![Downloads](http://img.shields.io/npm/dm/@dramaorg/hic-odio.svg?style=flat-square)](https://www.npmjs.org/package/@dramaorg/hic-odio)
[![Build Status](https://img.shields.io/travis/dramaorg/hic-odio/master.svg?style=flat-square)](https://travis-ci.org/dramaorg/hic-odio)
[![Coverage Status](https://img.shields.io/coveralls/dramaorg/hic-odio/master.svg?style=flat-square)](https://coveralls.io/github/dramaorg/hic-odio?branch=master)
...
```sh
npm install --save-dev @dramaorg/hic-odio
```
